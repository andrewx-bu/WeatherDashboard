...
def get_random(num_books: int) -> int:
    """
    Fetches a random int between 1 and the number of books in the catalog from random.org.
    ...
    """
    url = f"https://www.random.org/integers/?num=1&min=1&max={num_books}&col=1&base=10&format=plain&rnd=new"
